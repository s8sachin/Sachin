...
describe "to_str" do
  ...
  it "should demonstrate to_s_returns_a_string_representation" do
    ...
    not_like_a_string.to_s.eql? __
  end

  it "should demonstrate normally_objects_cannot_be_used_where_strings_are_expected" do
    expect(File.exist?(CanNotBeTreatedAsString.new)).to raise_error("FILL ME IN")
  end
  ...
  it "should demonstrate user_defined_code_can_check_for_to_str" do
    acts_like_a_string?(CanNotBeTreatedAsString.new).eql? __
    acts_like_a_string?(CanBeTreatedAsString.new).eql? __
  end
end